				...
				<div class="col">
					...
					<div class="blog_posts">
						...
						<div class="blog_post">
							<div class="row">
								<div class="col-xl-7 col-lg-6">
									<div class="blog_post_image"><img src="images/blog_1.jpg" alt="https://unsplash.com/@nickkarvounis"></div>
								</div>
						...
						<div class="blog_post">
							<div class="row">
								<div class="col-xl-7 col-lg-6">
									<div class="blog_post_image"><img src="images/blog_2.jpg" alt="https://unsplash.com/@ollivves"></div>
								</div>
								<div class="col-xl-5 col-lg-6">
									<div class="blog_post_content">
										<div class="bp_date trans_200"><a href="#">July 26, 2018</a></div>
										<div class="pb_title"><a href="#">Tips to have a great vacation</a></div>
										<div class="pb_info">
											<ul class="d-flex flex-row align-items-center justify-content-start">
												<li><a href="#">By Admin</a></li>
												<li>
						...
						<div class="blog_post">
							<div class="row">
								<div class="col-xl-7 col-lg-6">
									<div class="blog_post_image"><img src="images/blog_3.jpg" alt="https://unsplash.com/@shazmynphotos1"></div>
								</div>
								<div class="col-xl-5 col-lg-6">
									<div class="blog_post_content">
										<div class="bp_date trans_200"><a href="#">July 26, 2018</a></div>
										<div class="pb_title"><a href="#">Get the perfect tan for the summer</a></div>
										<div class="pb_info">
											<ul class="d-flex flex-row align-items-center justify-content-start">
												<li><a href="#">By Admin</a></li>
												<li>
						...
						<div class="blog_post">
							<div class="row">
								<div class="col-xl-7 col-lg-6">
									<div class="blog_post_image"><img src="images/blog_4.jpg" alt="https://unsplash.com/@derekrliang"></div>
								</div>
								<div class="col-xl-5 col-lg-6">
									<div class="blog_post_content">
										<div class="bp_date trans_200"><a href="#">July 26, 2018</a></div>
										<div class="pb_title"><a href="#">Amazing places you should visit</a></div>
										<div class="pb_info">
											<ul class="d-flex flex-row align-items-center justify-content-start">
												<li><a href="#">By Admin</a></li>
												<li>
