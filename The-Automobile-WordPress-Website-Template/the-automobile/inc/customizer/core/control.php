 ...
 */
class The_Automobile_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class The_Automobile_Customize_Section_Upsell extends WP_Customize_Section {
