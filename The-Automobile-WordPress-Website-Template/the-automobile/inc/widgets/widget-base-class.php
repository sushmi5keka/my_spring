 ...
 * @since 1.0.0
 */
class The_Automobile_Widget_Base extends WP_Widget {
		...
		switch ( $field_type ) {
			...
			case 'image':
				...
				<div>
					...
					<!-- <br /> -->
					<input type="button" class="select-img button button-primary" value="<?php esc_attr_e( 'Upload', 'the-automobile' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'the-automobile' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'the-automobile' ); ?>" />
					<?php
					$image_status = false;
					if ( ! empty( $value ) ) {
						$image_status = true;
					...
					?>
					<input type="button" value="<?php echo esc_attr_x( 'X', 'Remove', 'the-automobile' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $remove_button_style ); ?>" />
